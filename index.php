...
<body>
	...
	<!-- <script>var phpUrl = {"base":"192.168.2.231\/codex\/","path":"","routes":{"home":""},"protocol":"https:\/\/"}</script> -->

	<!-- <script src="asset/lib.js?1"></script> -->
	<!-- <script src="asset/common.bundle.js?1"></script> -->
</body>
</html>
